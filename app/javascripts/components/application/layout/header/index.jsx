...
import KetteLogoImage from '@/../images/logos/kette-logo.png'
        ...
        <div className="container">
          ...
          <div
            ...
            <div className="navbar-start">
              <div className="navbar-item">
                <NavLink to="/tokens/register" activeClassName="is-active"  className="button is-info">
